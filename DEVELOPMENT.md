...
- [ ] **Βελτίωση γλώσσας:** έλεγχος και βελτίωση των κειμένων του UI και των μεταφράσεων, με έμφαση σε φυσική διατύπωση, συνέπεια όρων και πλήρη κάλυψη των translation keys.
