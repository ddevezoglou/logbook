...
Άξονας: **φάση 1 δωρεάν προϊόν (όχι open source), τελικός στόχος κέρδος από κινητό.** Εδώ καταγράφονται αποκλειστικά τα πραγματικά ανοιχτά TODO. Οι ολοκληρωμένες εργασίες και οι κλεισμένες αποφάσεις βρίσκονται στις προηγούμενες ενότητες.
