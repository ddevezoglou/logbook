(function () {
  ...
  const catalog = {
    ...
    'library.deleted':['Η άσκηση διαγράφηκε. Το ιστορικό διατηρήθηκε.','Exercise deleted. History has been preserved.','Exercice supprimé. L’historique a été conservé.','Übung gelöscht. Der Verlauf bleibt erhalten.'],
    'library.delete-warning':['Η άσκηση «{name}» θα διαγραφεί από τη βιβλιοθήκη, από όλα τα προγράμματα που τη χρησιμοποιούν και από την επίβλεψη. Οι παλιές καταγραφές στο ιστορικό θα διατηρηθούν. Θέλετε να συνεχίσετε;','The exercise “{name}” will be deleted from the library, all programs that use it, and progress tracking. Past entries in history will be preserved. Continue?','L’exercice « {name} » sera supprimé de la bibliothèque, de tous les programmes qui l’utilisent et du suivi. Les anciennes entrées de l’historique seront conservées. Continuer ?','Die Übung „{name}“ wird aus der Bibliothek, allen zugehörigen Programmen und der Fortschrittsübersicht gelöscht. Frühere Einträge im Verlauf bleiben erhalten. Fortfahren?'],
    ...
    'message.0007':['Δεν ολοκληρώθηκε ο συγχρονισμός. Ελέγξτε τη σύνδεσή σας και δοκιμάστε ξανά.','Sync did not complete. Check your connection and try again.','La synchronisation n’a pas abouti. Vérifiez votre connexion et réessayez.','Die Synchronisierung wurde nicht abgeschlossen. Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.'],
    ...
    'message.0121':['Επιλέξτε άσκηση και σετ για να δείτε την πορεία τους σε όλες τις καταγραφές σας.','Choose an exercise and a set to see their progress across all your records.','Choisissez un exercice et une série pour suivre leur progression dans tous vos enregistrements.','Wählen Sie eine Übung und einen Satz, um deren Entwicklung über alle Aufzeichnungen hinweg zu sehen.'],
    ...
    'message.0163':['ΕΠΙΛΟΓΗ','SELECT','SÉLECTIONNER','AUSWÄHLEN'],
    ...
    'message.0202':['Πλάκες','Plates','Plaques','Scheiben'],
    ...
    'message.0420':['Να διαγραφεί οριστικά η προπόνηση','Permanently delete the workout','Supprimer définitivement la séance','Das Training endgültig löschen'],
    ...
    'message.0487':['Χρησιμοποιήστε το μολύβι για επεξεργασία και το × για διαγραφή· η σημείωση ξεχωρίζει τις ομώνυμες ασκήσεις.','Use the pencil to edit and × to delete; the note distinguishes exercises with the same name.','Utilisez le crayon pour modifier et × pour supprimer ; la note distingue les exercices de même nom.','Mit dem Stift bearbeiten, mit × löschen; die Notiz unterscheidet gleichnamige Übungen.'],
    ...
    'plan.index-hint':['Μολύβι για επεξεργασία · × για διαγραφή.','Pencil to edit · × to delete.','Crayon pour modifier · × pour supprimer.','Stift zum Bearbeiten · × zum Löschen.'],
    'library.edit':['Επεξεργασία άσκησης','Edit exercise','Modifier l’exercice','Übung bearbeiten'],
