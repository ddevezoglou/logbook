(function () {
  ...
  const p = {
    ...
    'Μονάδα μέτρησης':['Measurement unit','Unité de mesure','Maßeinheit'],
    'Εξαγωγή ιστορικού':['Export history','Exporter l’historique','Verlauf exportieren'],
    'Δεν υπάρχουν καταγεγραμμένες προπονήσεις για εξαγωγή.':['There are no logged workouts to export.','Aucune séance enregistrée n’est disponible pour l’export.','Es sind keine erfassten Trainings zum Exportieren vorhanden.'],
    'Δεν ήταν δυνατή η εξαγωγή του ιστορικού.':['History could not be exported.','L’historique n’a pas pu être exporté.','Der Verlauf konnte nicht exportiert werden.'],
    'ΑΡΧΕΙΟ':['FILE','FICHIER','DATEI'],
    ...
    'Διαλέξτε ημερομηνία και «Από το πρόγραμμα» ή «Ελεύθερη» προπόνηση.':['Choose a date and either a “Scheduled” or “Free” workout.','Choisissez une date et une séance « Depuis le programme » ou « Libre ».','Wählen Sie ein Datum und ein Training „Nach Plan“ oder „Frei“.'],
    'Μετακινηθείτε στις κάρτες ασκήσεων με τα βέλη ή με σύρσιμο.':['Move through the exercise cards with the arrows or by swiping.','Parcourez les cartes d’exercices avec les flèches ou en les faisant glisser.','Wechseln Sie mit den Pfeilen oder durch Wischen zwischen den Übungskarten.'],
    ...
    'Προσθέστε ή αφαιρέστε σετ, αντιγράψτε το πρώτο στα υπόλοιπα και γράψτε σχόλια όπου χρειάζεται.':['Add or remove sets, copy the first to the rest and add notes where needed.','Ajoutez ou retirez des séries, copiez la première sur les autres et ajoutez des notes si nécessaire.','Fügen Sie Sätze hinzu oder entfernen Sie sie, kopieren Sie den ersten auf die übrigen und ergänzen Sie bei Bedarf Notizen.'],
    'Με «Ολοκλήρωση προπόνησης» η καταγραφή αποθηκεύεται στο Ιστορικό. Από εκεί μπορείτε να τη διορθώσετε ή να την αντιγράψετε.':['“Complete workout” saves the log to History. From there you can edit or copy it.','« Terminer la séance » enregistre la saisie dans l’historique. Vous pouvez ensuite la modifier ou la copier.','„Training abschließen“ speichert den Eintrag im Verlauf. Dort können Sie ihn bearbeiten oder kopieren.'],
    'Δημιουργήστε όσα προγράμματα θέλετε, με διάρκεια 3–10 ημερών και προαιρετική δήλωση ημερών εβδομάδας.':['Create as many routines as you like, lasting 3–10 days, with optional weekdays.','Créez autant de programmes que vous le souhaitez, sur 3 à 10 jours, avec des jours de semaine facultatifs.','Erstellen Sie beliebig viele Pläne mit 3–10 Tagen und optionalen Wochentagen.'],
    'Προσθέστε σε κάθε προπόνηση όνομα, ασκήσεις, εργάσιμα σετ και cues.':['Add a name, exercises, working sets and cues to each workout.','Ajoutez à chaque séance un nom, des exercices, des séries de travail et des consignes.','Fügen Sie jedem Training einen Namen, Übungen, Arbeitssätze und Hinweise hinzu.'],
    'Ανοίξτε ένα πρόγραμμα για επεξεργασία, αντιγραφή ή διαγραφή και ορίστε με το αστέρι ποιο είναι ενεργό.':['Open a routine to edit, copy or delete it, and use the star to make it active.','Ouvrez un programme pour le modifier, le copier ou le supprimer, puis utilisez l’étoile pour l’activer.','Öffnen Sie einen Plan zum Bearbeiten, Kopieren oder Löschen und aktivieren Sie ihn mit dem Stern.'],
    'Όταν αλλάζετε ημέρα ή ονόματα, επιλέξτε αν θα ενημερωθεί μαζί και το παλιό Ιστορικό.':['When changing a day or names, choose whether previous History should update too.','Lorsque vous changez un jour ou des noms, choisissez si l’ancien historique doit aussi être mis à jour.','Wählen Sie beim Ändern eines Tages oder Namens, ob der frühere Verlauf ebenfalls aktualisiert werden soll.'],
    'Το γράφημα συγκρίνει βάρος ή πλάκες και δείχνει την πορεία των επαναλήψεων στο ίδιο φορτίο.':['The chart compares weight or plates and shows how reps progress at the same load.','Le graphique compare la charge ou les disques et montre l’évolution des répétitions à charge égale.','Das Diagramm vergleicht Gewicht oder Scheiben und zeigt die Wiederholungsentwicklung bei gleicher Last.'],
    'Καταγραφές με ασύμβατη μέτρηση εξαιρούνται και εμφανίζονται στον έλεγχο κάτω από το γράφημα.':['Logs with an incompatible measurement are excluded and listed below the chart.','Les saisies avec une mesure incompatible sont exclues et signalées sous le graphique.','Einträge mit inkompatibler Messart werden ausgeschlossen und unter dem Diagramm aufgeführt.'],
    'Ανοίξτε το «Personal Records» για τα καλύτερα σετ κάθε άσκησης και τρόπου μέτρησης.':['Open “Personal Records” for the best sets in each exercise and measurement method.','Ouvrez « Personal Records » pour voir les meilleures séries de chaque exercice et mode de mesure.','Öffnen Sie „Personal Records“ für die besten Sätze jeder Übung und Messart.'],
    'Ανεβάστε έως έξι εικόνες και επιλέξτε ποια θα χρησιμοποιείται στο προφίλ.':['Upload up to six images and choose which one to use for your profile.','Importez jusqu’à six images et choisissez celle à utiliser pour votre profil.','Laden Sie bis zu sechs Bilder hoch und wählen Sie das Profilbild aus.'],
    ...
    'Αποθηκεύστε τις αλλαγές για να ενημερωθούν η Αρχική και το μενού.':['Save your changes to update Home and the menu.','Enregistrez les modifications pour mettre à jour l’accueil et le menu.','Speichern Sie die Änderungen, um Startseite und Menü zu aktualisieren.'],
    ...
    'Άνοιγμα Personal Records':['Open Personal Records','Ouvrir les Personal Records','Personal Records öffnen'],
    'Κλείσιμο Personal Records':['Close Personal Records','Fermer les Personal Records','Personal Records schließen'],
    ...
    'ΑΛΛΑΓΗ ΦΩΤΟΓΡΑΦΙΑΣ':['CHANGE PHOTO','CHANGER LA PHOTO','FOTO ÄNDERN'],
    'Αλλαγή φωτογραφίας':['Change photo','Changer la photo','Foto ändern'],
    'Αλλαγή ονόματος':['Change name','Changer le nom','Namen ändern'],
    'ΦΩΤΟΓΡΑΦΙΕΣ ΠΡΟΦΙΛ':['PROFILE PHOTOS','PHOTOS DE PROFIL','PROFILFOTOS'],
    'Φωτογραφίες προφίλ':['Profile photos','Photos de profil','Profilfotos'],
    'ΑΝΕΒΑΣΜΑ ΝΕΑΣ':['UPLOAD NEW','IMPORTER UNE NOUVELLE','NEUES HOCHLADEN'],
    'ΚΛΕΙΣΙΜΟ':['CLOSE','FERMER','SCHLIESSEN'],
    'ΗΜΕΡΟΜΗΝΙΑ ΓΕΝΝΗΣΗΣ':['DATE OF BIRTH','DATE DE NAISSANCE','GEBURTSDATUM'],
    'Απόκρυψη ηλικίας από την κάρτα':['Hide age from the card','Masquer l’âge sur la carte','Alter auf der Karte ausblenden'],
    'Η ημερομηνία μένει αποθηκευμένη — απλώς δεν φαίνεται στην κάρτα.':['The date stays saved — it just is not shown on the card.','La date reste enregistrée — elle n’apparaît simplement pas sur la carte.','Das Datum bleibt gespeichert — es wird nur nicht auf der Karte angezeigt.'],
    'ΣΕ ΧΡΗΣΗ':['IN USE','UTILISÉE','IN VERWENDUNG'],
    'ΕΠΙΛΟΓΗ':['SELECT','CHOISIR','AUSWÄHLEN'],
    'Φωτογραφία σε χρήση':['Photo in use','Photo utilisée','Verwendetes Foto'],
    'Χρήση αυτής της φωτογραφίας':['Use this photo','Utiliser cette photo','Dieses Foto verwenden'],
    'Συμπληρώστε όνομα για την κάρτα.':['Enter a name for the card.','Saisissez un nom pour la carte.','Geben Sie einen Namen für die Karte ein.'],
    'Συμπληρώστε έγκυρη ημερομηνία γέννησης.':['Enter a valid date of birth.','Saisissez une date de naissance valide.','Geben Sie ein gültiges Geburtsdatum ein.'],
    ...
    'ΤΟ ΑΠΟΤΥΠΩΜΑ':['MARK','L’EMPREINTE','DIE SPUR'],
    'ΜΕΝΕΙ.':['REMAINS.','RESTE.','BLEIBT.'],
    'ΤΟ ΠΛΑΝΟ':['PLAN','LE PLAN','DER PLAN'],
    'ΟΔΗΓΕΙ.':['LEADS.','GUIDE.','FÜHRT.'],
    'Η ΔΟΥΛΕΙΑ':['WORK','LE TRAVAIL','DIE ARBEIT'],
    ...
    'ΤΟ ΣΗΜΕΡΑ.':['TODAY.','AUJOURD’HUI.','HEUTE.'],
    ...
    'Η σημερινή προπόνηση καταγράφηκε — η ανάπτυξη έρχεται με την ξεκούραση':['Today’s workout is logged — growth comes with rest','L’entraînement du jour est enregistré — la croissance vient avec le repos','Das heutige Training ist erfasst — Wachstum kommt mit der Erholung'],
    ...
    'Μέτρηση':['Measure','Mesure','Messart'],
    'Πλάκες':['Plates','Disques','Scheiben'],
    'Βάρος (kg)':['Weight (kg)','Charge (kg)','Gewicht (kg)'],
    'Βάρος (lbs)':['Weight (lbs)','Charge (lbs)','Gewicht (lbs)'],
    ...
    'Τοπική αποθήκευση · αναμονή για συγχρονισμό.':['Local storage · waiting to sync.','Stockage local · en attente de synchronisation.','Lokale Speicherung · Synchronisierung ausstehend.'],
    'Πατήστε τη φωτογραφία, το όνομα ή την ηλικία πάνω στην κάρτα.':['Tap the photo, name, or age on the card.','Touchez la photo, le nom ou l’âge sur la carte.','Tippen Sie auf Foto, Name oder Alter auf der Karte.'],
    'Εκτός σύνδεσης':['Offline','Hors ligne','Offline'],
    ...
    'Εκκίνηση εκτός σύνδεσης με τα δεδομένα αυτής της συσκευής.':['Starting offline with this device’s data.','Démarrage hors ligne avec les données de cet appareil.','Offline-Start mit den Daten dieses Geräts.'],
    'Η σύνδεση επανήλθε · συγχρονισμός δεδομένων…':['Connection restored · syncing data…','Connexion rétablie · synchronisation des données…','Verbindung wiederhergestellt · Daten werden synchronisiert…'],
    ...
    'ΔΙΑΓΡΑΦΗ ΛΟΓΑΡΙΑΣΜΟΥ':['DELETE ACCOUNT','SUPPRIMER LE COMPTE','KONTO LÖSCHEN'],
    'ΜΗ ΑΝΑΣΤΡΕΨΙΜΗ ΕΝΕΡΓΕΙΑ':['IRREVERSIBLE ACTION','ACTION IRRÉVERSIBLE','UNWIDERRUFLICHE AKTION'],
    'Οριστική διαγραφή λογαριασμού':['Permanently delete account','Supprimer définitivement le compte','Konto endgültig löschen'],
    ...
    'ΑΚΥΡΩΣΗ':['CANCEL','ANNULER','ABBRECHEN'],
    'ΝΑΙ, ΔΙΑΓΡΑΦΗ':['YES, DELETE','OUI, SUPPRIMER','JA, LÖSCHEN'],
    'Γίνεται οριστική διαγραφή του λογαριασμού σας…':['Permanently deleting your account…','Suppression définitive de votre compte…','Ihr Konto wird endgültig gelöscht…'],
    'Δεν ήταν δυνατή η διαγραφή του λογαριασμού. Δοκιμάστε ξανά.':['The account could not be deleted. Try again.','Le compte n’a pas pu être supprimé. Réessayez.','Das Konto konnte nicht gelöscht werden. Versuchen Sie es erneut.'],
    ...
    'Ξεκινήστε πρώτα τον τοπικό server και ανοίξτε το Logbook από http://localhost:3000/.':['Start the local server first and open Logbook at http://localhost:3000/.','Démarrez d’abord le serveur local et ouvrez Logbook sur http://localhost:3000/.','Starten Sie zuerst den lokalen Server und öffnen Sie Logbook unter http://localhost:3000/.'],
    ...
    'Προβολή πλάνου':['View plan','Voir le programme','Plan anzeigen'],
    'Προσθήκη προπόνησης':['Add workout','Ajouter une séance','Training hinzufügen'],
    'Αντιγραφή προγράμματος':['Duplicate routine','Dupliquer le programme','Plan duplizieren'],
    'Κλείσιμο πλάνου':['Close plan','Fermer le programme','Plan schließen'],
    'Κλείσιμο προπόνησης':['Close workout','Fermer la séance','Training schließen'],
    ...
    'Πλάκες+Κιλά':['Plates+kg','Plaques+kg','Scheiben+kg'],
    'Πλάκες+Λίβρες':['Plates+lbs','Plaques+lbs','Scheiben+lbs'],
    'Πλάκες':['Plates','Plaques','Scheiben'],
    'Κιλά':['kg','kg','kg'],
    'Λίβρες':['lbs','lbs','lbs'],
    'Bodyweight + Extra Βάρος':['Bodyweight + Extra Weight','Poids du corps + charge','Körpergewicht + Zusatzgewicht'],
    'Bodyweight+Κιλά':['Bodyweight + kg','Poids du corps + kg','Körpergewicht + kg'],
    'Bodyweight+Λίβρες':['Bodyweight + lbs','Poids du corps + lbs','Körpergewicht + lbs'],
    'Μη αποθηκευμένη καταγραφή':['Unsaved workout log','Saisie non enregistrée','Nicht gespeicherter Trainingseintrag'],
    'Έχετε μη αποθηκευμένα δεδομένα προπόνησης. Αν αποχωρήσετε χωρίς αποθήκευση, θα χαθούν. Θέλετε να αποθηκεύσετε την καταγραφή πριν συνεχίσετε;':['You have unsaved workout data. If you leave without saving, it will be lost. Would you like to save the log before continuing?','Vous avez des données d’entraînement non enregistrées. Si vous partez sans enregistrer, elles seront perdues. Souhaitez-vous enregistrer la saisie avant de continuer ?','Sie haben nicht gespeicherte Trainingsdaten. Wenn Sie ohne Speichern fortfahren, gehen sie verloren. Möchten Sie den Eintrag vorher speichern?'],
    'Έξοδος χωρίς αποθήκευση':['Leave without saving','Quitter sans enregistrer','Ohne Speichern verlassen'],
    'Παραμονή':['Stay','Rester','Bleiben'],
    ...
    'Αφαίρεση σετ':['Remove set','Retirer la série','Satz entfernen'],
    'Αφαίρεση':['Remove','Retirer','Entfernen'],
    'Είστε σίγουροι ότι θέλετε να πραγματοποιηθεί αφαίρεση του εργάσιμου σετ ;':['Are you sure you want to remove the working set?','Êtes-vous sûr de vouloir retirer la série de travail ?','Möchten Sie den Arbeitssatz wirklich entfernen?'],
    'Αφαίρεση εργάσιμου σετ':['Remove working set','Retirer la série de travail','Arbeitssatz entfernen'],
    'Χρειάζεται να υπάρχει τουλάχιστον ένα εργάσιμο σετ':['At least one working set is required','Au moins une série de travail est requise','Mindestens ein Arbeitssatz ist erforderlich'],
    'Το εργάσιμο σετ αφαιρέθηκε':['The working set was removed','La série de travail a été retirée','Der Arbeitssatz wurde entfernt'],
