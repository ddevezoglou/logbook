(function () {
  ...
  const p = {
    ...
    'Ό,τι ανεβάζετε μένει εδώ για να το ξαναδιαλέξετε αργότερα.':['Everything you upload stays here so you can pick it again later.','Tout ce que vous importez reste ici pour pouvoir le choisir à nouveau plus tard.','Alles, was Sie hochladen, bleibt hier, damit Sie es später erneut auswählen können.'],
