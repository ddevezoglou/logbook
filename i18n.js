(function () {
  ...
  const p = {
    ...
    'Ανεβάστε ή επιλέξτε την εικόνα προφίλ σας.':['Upload or select your profile image.','Importez ou sélectionnez votre photo de profil.','Laden Sie Ihr Profilbild hoch oder wählen Sie es aus.'],
    'Αποθηκεύστε τις αλλαγές για να ενημερωθεί η κάρτα στην Αρχική.':['Save your changes to update the card on Home.','Enregistrez les modifications pour actualiser la carte d’accueil.','Speichern Sie die Änderungen, um die Karte auf der Startseite zu aktualisieren.'],
